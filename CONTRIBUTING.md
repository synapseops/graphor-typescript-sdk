...
```sh
# Clone
$ git clone https://www.github.com/stainless-sdks/graphor-typescript-project-typescript
$ cd graphor-typescript-project-typescript

# With yarn
$ yarn link
$ cd ../my-package
$ yarn link graphor-typescript-project

# With pnpm
$ pnpm link --global
$ cd ../my-package
$ pnpm link -—global graphor-typescript-project
```
