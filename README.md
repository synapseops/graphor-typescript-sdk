...
```sh
npm install git+ssh://git@github.com:stainless-sdks/graphor-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install graphor`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/graphor-typescript/issues) with questions, bugs, or suggestions.
