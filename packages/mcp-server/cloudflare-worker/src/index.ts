...
import { McpOptions } from 'graphor-mcp/options';
import { initMcpServer, newMcpServer } from 'graphor-mcp/server';
import { configureLogger } from 'graphor-mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'graphor_api', version: '0.20.1' },
